...
※注意：solverはAMD64のAVX2およびBMI2を使っているので、Intel CPUならHaswell世代以降、AMD CPUならExcavator世代以降でないと動作しない。また、BMI2のpdep/pext命令を多用しているので、Zen2およびそれ以前の世代のAMD CPUでは実行時間が長くかかるかもしれない。
